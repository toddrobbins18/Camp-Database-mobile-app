/** Supported camp seasons in The Nest (mobile). */
export const AVAILABLE_SEASONS = ['2025', '2026', '2027'] as const;

export type CampSeason = (typeof AVAILABLE_SEASONS)[number];

/** Default working season after 2026→2027 rollover (matches web). */
export const DEFAULT_SEASON: CampSeason = '2027';

/** Bump to reset users to DEFAULT_SEASON once (AsyncStorage bootstrap). */
