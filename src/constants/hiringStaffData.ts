...
export interface HiringStaffMember {
  id: string;
  name: string;
  position: string;
  department: string;
...
export const initialHiringStaffData: HiringStaffMember[] = [
...
export const HIRING_COLUMNS: { status: HiringStatus; title: string }[] = [
...
export const HIRING_STORAGE_KEY_PREFIX = 'hiring-board-state-v1';
