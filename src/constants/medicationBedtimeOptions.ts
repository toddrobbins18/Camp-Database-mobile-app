...
export const MEDICATION_BEDTIME_OPTIONS: MedicationBedtimeOption[] = [
    { id: 'bedtime-21-00-freshman', division: 'Freshman A & B', mealTimeLabel: 'For Freshman A & B: 9:00PM', scheduledTimeHHmm: '21:00' },
    { id: 'bedtime-21-15-cadets', division: 'Cadets', mealTimeLabel: 'Cadets 9:15PM', scheduledTimeHHmm: '21:15' },
    { id: 'bedtime-21-30-sophomores', division: 'Sophomores', mealTimeLabel: 'Sophomores 9:30PM', scheduledTimeHHmm: '21:30' },
    { id: 'bedtime-21-45-juniors', division: 'Juniors', mealTimeLabel: 'Juniors 9:45PM', scheduledTimeHHmm: '21:45' },
    { id: 'bedtime-22-00-seniors', division: 'Seniors', mealTimeLabel: 'Seniors 10PM', scheduledTimeHHmm: '22:00' },
    { id: 'bedtime-22-15-supers', division: 'Supers', mealTimeLabel: 'Supers 10:15PM', scheduledTimeHHmm: '22:15' },
    { id: 'bedtime-22-30-teens', division: 'Teens', mealTimeLabel: 'Teens 10:30 PM', scheduledTimeHHmm: '22:30' },
    { id: 'bedtime-22-45-cits', division: 'CITS', mealTimeLabel: 'CITS 10:45PM', scheduledTimeHHmm: '22:45' },
];
