// Bunking auto-optimizer — shared with tyler-hill web Bunking page.
...
export function optimizeCabins(campers: OptCamper[], opts: OptimizeOptions): OptimizeResult {
