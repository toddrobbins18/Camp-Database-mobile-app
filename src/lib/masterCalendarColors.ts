import type { EventSource } from '../api/calendar_events';

export type CalendarAccent = { bg: string; text: string; marker: string };

/** Default event colors aligned with web Master Calendar. */
...
/** Resolve solid background color for an event (mirrors web MasterCalendar eventPropGetter). */
...
/** Calendar dot / list accent from event color. */
