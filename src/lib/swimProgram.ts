...
export function loadSwimProgramDataForCompany(companyId: string, season: string) {
  return loadSwimProgramData(supabase, companyId, season);
}

export function saveSwimBraceletForCompany(companyId: string, season: string, record: BraceletRecord) {
  return saveSwimBracelet(supabase, companyId, season, record);
}

export function saveSwimLevelForCompany(companyId: string, season: string, record: LevelRecord) {
  return saveSwimLevel(supabase, companyId, season, record);
}

export function fetchSwimHistoryReportForCompany(companyId: string) {
  return fetchSwimHistoryReport(supabase, companyId);
}

export function fetchSwimSeasonsForCompany(companyId: string) {
  return fetchSwimSeasons(supabase, companyId);
}
