...
function filterActiveRoster<T extends { status?: string | null }>(rows: T[] | null | undefined): T[] {
...
/** Sync sunshine groups/campers from roster (children.group_name = FULLSUMMERGROUP). */
