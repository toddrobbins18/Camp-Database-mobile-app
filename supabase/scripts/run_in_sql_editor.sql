...
-- Use these so the app behaves like Lovable's (super_admin, approvals, roles).
-- =============================================================================

-- ##############################################################################
-- SCRIPT 1: Allow super_admins to approve users
-- (profiles UPDATE + user_roles INSERT)
-- ##############################################################################
...
-- ##############################################################################
-- SCRIPT 2: Ensure Todd is super_admin (run after Todd has signed up once)
-- ##############################################################################
...
-- Run only if role_permissions and app_role already exist. Fills missing rows.
-- ##############################################################################
